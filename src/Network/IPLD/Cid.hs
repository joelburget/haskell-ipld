...
instance Enum Multibase where
  ...
  fromEnum = \case
    ...
    other -> fromEnum $ case other of
      ...
      Base64Pad         -> 'M'
      Base64UrlPad      -> 'U'
      IdentityMultibase -> error "impossible"

instance HumanOrCompact Multibase where
  human = \case
    IdentityMultibase -> "identity"
    Base1             -> "base1"
    Base2             -> "base2"
    Base8             -> "base8"
    Base10            -> "base10"
